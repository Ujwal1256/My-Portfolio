                ...
                <div className="flex flex-col md:flex-row md:justify-between gap-10">
                    ...
                    <div className="flex flex-col items-start md:w-1/2 space-y-6">
                        ...
                        <div className="flex space-x-4 mt-4">
                            <a href="https://www.linkedin.com/in/ujwal-jakhamate-894182370/" target="_blank" rel="noreferrer" className="border px-4 py-2 rounded text-blue-600 hover:bg-blue-50 flex items-center">
                            ...
                            <a href="https://github.com/Ujwal1256" target="_blank" rel="noreferrer" className="border px-4 py-2 rounded text-purple-600 hover:bg-purple-50 flex items-center">
